...
<table class="table table-striped">
	...
	<tbody><?php foreach ($admin as $key) { ?>
		<!-- <tr><td><?php echo $key->id_admin;?></td> -->
			...
			<td><a href="<?=site_url()?>index.php/admin/Update/<?php echo "$key->id_admin"?>"><p data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit"><span class="glyphicon glyphicon-pencil"></span></button></p></a></td>
